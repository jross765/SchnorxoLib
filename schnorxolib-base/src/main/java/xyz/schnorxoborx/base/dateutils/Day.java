  ...
  implements Comparable, Cloneable, Serializable
{
   ...
   * 
   */
  private static final long serialVersionUID = -6887397562669784514L;
  ...
  /**
   * Analogous to Day(Date date), but with LocalDate
   */
  public Day (LocalDate date)
  {
    // Create a calendar based on given date
    Calendar calendar = Calendar.getInstance();
    calendar.setTime (LocalDateHelpers.toDate(date));
  ...
  {
    return LocalDateHelpers.toLocalDate(getDate());
  }
  ...
  {
    return isBeforeCore(day.calendar_, calendar_);
  }
   ...
   */
  public boolean isAfterTime (Day day)
  {
  ...
  {
    return isBeforeCore(calendar_, day.calendar_);
  }
   ...
   * @return      True if this is before day, false otherwise.
   */
  public boolean isBeforeTime (Day day)
  {
  ...
  /**
   * Return true if this day is before the specified day.
   * Just date, time is ignored. Ugly, but works fine.
   * 
   * https://stackoverflow.com/questions/11916743/calendar-before-and-calendar-after-returning-incorrect-values
   * 
   * @param date  Day to compare to.
   * @return      True if this is equal to day, false otherwise.
   */
  private static boolean isBeforeCore(Calendar c1, Calendar c2)
  {
  ...
  {
    return equalsCore(calendar_, day.calendar_);
  }
   ...
   * @return      True if this equals day, false otherwise.
   */
  public boolean equalsTime (Day day)
  {
  ...
  /**
   * Return true if this day is before the specified day.
   * Just date, time is ignored. Analogous to isBeforeCore: Ugly, but does
   ...
   * @return      True if this is before day, false otherwise.
   */
  private static boolean equalsCore(Calendar c1, Calendar c2)
  {
    int c1Year = c1.get(Calendar.YEAR);
    int c1Month = c1.get(Calendar.MONTH);
    int c1Day = c1.get(Calendar.DAY_OF_MONTH);
  ...
  public void set (Day value)
  {
    set(value.getYear(), value.getMonth(), value.getDayOfMonth());
  }
...
//    System.err.println("tt: " + calendar_.get(Calendar.YEAR) + "." +
//                                ( calendar_.get(Calendar.MONTH) + 1 ) + "." + 
//                                calendar_.get(Calendar.DAY_OF_MONTH) );
  }
