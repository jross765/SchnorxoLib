...
public class TestBigRational {
	...
	public static junit.framework.Test suite() {
    	return new JUnit4TestAdapter(TestBigRational.class);
    }
    ...
    public void test01_2() throws Exception {
    	BigRational num = new BigRational(0);
    	assertEquals(0.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(0, num.intValue());
    ...
    public void test01_3() throws Exception {
    	BigRational num = BigRational.of(BigDecimal.valueOf(0));
    	assertEquals(0.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(0, num.intValue());

    	num = BigRational.of(BigDecimal.valueOf(1));
    	assertEquals(1.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(1, num.intValue());

    	num = BigRational.of(BigDecimal.valueOf(18));
    	assertEquals(18.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(18, num.intValue());
    	...
    	num = BigRational.of(BigDecimal.valueOf(48238112));
    	assertEquals(48238112.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(48238112, num.intValue());
    }
    ...
    public void test02_1() throws Exception {
    	...
    	num.add(new BigRational("1"));
    	assertEquals(1.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(1, num.intValue());

    	num.add(new FixedPointNumber("1").asBigRational());
    	assertEquals(2.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(2, num.intValue());
    	...
    	num.subtract(new BigRational("13"));
    	assertEquals(0.127, num.doubleValue(), ConstTest.DIFF_TOLERANCE);

    	num.subtract(new BigRational("127/1000"));
    	assertEquals(0.0, num.doubleValue(), ConstTest.DIFF_TOLERANCE);
    	// assertEquals(0, num.intValue());
...
//    	BigRational fp = new BigRational("3/2");
...
//    	BigRational fp1 = new BigRational("2123");
//    	BigRational fp2 = new BigRational("2123.00");
//    	assertEquals( fp1, fp2 );
//    	assertEquals( false, fp1.isLessThan( fp2 ) );
//    	assertEquals( false, fp1.isGreaterThan( fp2 ) );
//    	
//    	fp1 = new BigRational("2123");
//    	fp2 = new BigRational("2125");
...
//    	
//    	fp1 = new BigRational("-2123.00");
//    	fp2 = new BigRational("-2124.00");
//    	assertNotEquals( fp1, fp2 );
//    	assertEquals( false, fp1.isLessThan( fp2 ) );
//    	assertEquals( true, fp1.isGreaterThan( fp2 ) );
//    	assertEquals( true, fp2.isLessThan( fp1 ) );
...
//    	BigRational fp1 = new BigRational("2123");
//    	BigRational fp2 = new BigRational( fp1.getBigDecimal().add( BigDecimal.valueOf( ConstTest.DIFF_TOLERANCE * 2 ) ) );
//    	assertNotEquals( fp1, fp2 );
//    	assertEquals( true, fp1.isLessThan( fp2 ) );
//    	assertEquals( false, fp1.isGreaterThan( fp2 ) );
//    	
//    	fp2 = new BigRational( fp1.getBigDecimal().add( BigDecimal.valueOf( ConstTest.DIFF_TOLERANCE ) ) );
//    	assertNotEquals( fp1, fp2 );
//    	assertEquals( true, fp1.isLessThan( fp2 ) );
//    	assertEquals( false, fp1.isGreaterThan( fp2 ) );
//    	
//    	fp2 = new BigRational( fp1.getBigDecimal().add( BigDecimal.valueOf( ConstTest.DIFF_TOLERANCE * 0.5 ) ) );
//    	assertNotEquals( fp1, fp2 );
//    	assertEquals( true, fp1.isLessThan( fp2 ) );
//    	assertEquals( false, fp1.isGreaterThan( fp2 ) );
//    }
